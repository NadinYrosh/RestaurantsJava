...
--
-- Name: cuisine; Type: TABLE; Schema: public; Owner: Guest
--
...
COPY restaurants (id, name, hours, cuisine_id) FROM stdin;
\.
...
--
-- Name: cuisine_pkey; Type: CONSTRAINT; Schema: public; Owner: Guest
--
